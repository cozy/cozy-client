  ...
  return function (WrappedComponent) {
    ...
    var Wrapper = /*#__PURE__*/function (_Component) {
      ...
      function Wrapper(props, context) {
        ...
        console.warn("Deprecation: withMutations will be removed in the near future, prefer to use withClient to access the client. See https://github.com/cozy/cozy-client/pull/638 for more information.");
