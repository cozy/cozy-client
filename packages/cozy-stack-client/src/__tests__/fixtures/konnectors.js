export const ALL_KONNECTORS_RESPONSE = {
  data: [
    {
        ...
        locales: {
          fr: {
            ...
            permissions: {
              'bank operations': {
                description:
                  'Utilisé pour relier les factures à des operations bancaires'
              },
              bills: {
      ...
      attributes: {
        ...
        locales: {
          fr: {
            ...
            long_description:
              'Ce connecteur récupère une liste de factures sur le site https://delivreousa.fr',
            permissions: {
              'bank operations': {
                description:
                  'Utilisé pour relier les factures à des operations bancaires'
          ...
          en: {
            ...
            long_description:
              'This connector fetches a list of invoices from https://delivreousa.fr',
            permissions: {
              'bank operations': {
                description: 'Required to link bank operations to bills'
              },
      ...
      attributes: {
        ...
        locales: {
          fr: {
            ...
            long_description:
              "Ce fournisseur vous permettra de récupérer l'ensemble de vos facture Frit dans votre Cozy.",
            permissions: {
              'bank operations': {
                description:
                  'Utilisé pour relier les factures à des operations bancaires'
          ...
          en: {
            ...
            long_description:
              'This provider will allow you to fetch all your Frit bills in your Cozy.',
            permissions: {
              'bank operations': {
                description: 'Required to link bank operations to bills'
              },
    ...
    },
    {
      ...
      attributes: {
        ...
        locales: {
          fr: {
            short_description:
              'Récupère vos déclarations de revenu et autres taxes',
            long_description:
              'Récupère vos déclarations de revenu et autres taxes',
            permissions: {
              files: {
        ...
        version: '1.0.0',
        checksum:
          'beb4523d1af9afb5cccac16670a53616cdb77f6fd2e66dbf1166541be3d6df3f',
        permissions: {
          accounts: { type: 'io.cozy.accounts', verbs: ['GET'] },
          files: { type: 'io.cozy.files' }
        },
...
export const GET_KONNECTORS_RESPONSE = {
  data: {
    type: 'io.cozy.konnectors',
    id: 'io.cozy.konnectors/bouibox',
    attributes: {
