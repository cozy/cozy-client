 ...
 *
 * @param {import("cozy-client/types/types").IOCozyFile} file An io.cozy.files
...
/**
 *
 * @param {import("cozy-client/types/types").IOCozyFile} file io.cozy.files
 */
 ...
 *
 * @param {import("cozy-client/types/types").IOCozyFile} file - io.cozy.file document
 * @returns {boolean}
 */
 ...
 * @param {import("cozy-client/types/types").IOCozyFile} file - The file to qualify
 * @param {object} qualification - The file qualification
 * @returns {Promise<import("cozy-client/types/types").IOCozyFile>} The saved file
 */
 ...
 * @returns {Promise<import("cozy-client/types/types").QueryResult>} The files found by the rules
 */
 ...
 * @param {import("cozy-client/types/types").IOCozyFile} params.file - An io.cozy.files document
 ...
 *
 * @param {CozyClient} client                                                                    - The CozyClient instance
 * @param {import("cozy-client/types/types").IOCozyFile | import("cozy-client/types/types").NextcloudFile} file                - The file to move (required)
 * @param {import("cozy-client/types/types").IOCozyFolder | import("cozy-client/types/types").NextcloudFile} destination       - The destination folder (required)
 ...
 * @returns {Promise<{moved: undefined|import("cozy-client/types/types").IOCozyFile, deleted: null|string[] }>} - A promise that returns the move action response (if any)
 ...
 * @returns {Promise<import("cozy-client/types/types").IOCozyFile>} The overrided file
 */
 ...
 * @param {import("cozy-client/types/types").ConflictOptions} [conflictOptions] - Conflict options
 ...
 * @property {import("cozy-client/types/types").ConflictOptions} [conflictOptions] - Conflict options
 */
