 ...
 * @returns {Promise<import("cozy-client/types/types").IOCozyFolder>} Folder document
 */
 ...
 * @param  {import("cozy-client/types/types").CozyClientDocument}  document - Document to make reference to. Any doctype.
 * @returns {Promise<import("cozy-client/types/types").IOCozyFolder>}  Folder document
 */
 ...
 *
 * @param  {CozyClient}  client    cozy-client instance
 * @param  {import("cozy-client/types/types").CozyClientDocument}  document  Document to get references from
 * @returns {Promise<import("cozy-client/types/types").IOCozyFolder>} Folder referenced by the given document
 */
