...
const triggerStates = {
   ...
   *
   * @param {import('cozy-client/types/types').IOCozyTrigger} trigger - trigger object
...
const triggers = {
   ...
   *
   * @param {import('cozy-client/types/types').IOCozyTrigger} trigger - io.cozy.triggers
   *
   ...
   *
   * @param {import('cozy-client/types/types').IOCozyTrigger} trigger      io.cozy.triggers
   * @param {import('cozy-client/types/types').IOCozyAccount} account      io.cozy.accounts used by the trigger
   *
   ...
   * @param  {import('cozy-client/types/types').IOCozyKonnector} options.konnector - konnector object
   * @param  {import('cozy-client/types/types').IOCozyAccount} options.account - account object
   * @param  {String} [options.cron] - cron string. Defaults to '0 0 0 * * 0'
   * @param  {object} [options.folder] - folder object
   * @returns {import('cozy-client/types/types').IOCozyTrigger} created trigger
   */
