 ...
 * @param {import("cozy-client/types/types").IOCozyKonnector} options.konnector - io.cozy.konnectors document
 * @param {import("cozy-client/types/types").IOCozyAccount} options.account - io.cozy.accounts document
 * @param {String} options.lang - instance current language. ex: 'fr'
 * @returns {Promise<import("cozy-client/types/types").IOCozyFolder>}
 */
 ...
 * @returns {Promise<import("cozy-client/types/types").IOCozyFolder>}         Directory attributes
 */
 ...
 * @param  {CozyClient}  client CozyClient
 * @param  {string}  path   Directory path
 * @returns {Promise<import("cozy-client/types/types").IOCozyFolder|null>}        Created io.cozy.files document
 ...
 *
 * @param  {import("cozy-client/types/types").IOCozyKonnector} konnector Konnector document
 ...
 * @param  {import("cozy-client/types/types").IOCozyKonnector['name']} variables.konnector - konnector name
 ...
 *
 * @param  {import("cozy-client/types/types").IOCozyFolder} folder    The folder which the konnector should have access
 ...
 *
 * @param {import("cozy-client/types/types").IOCozyFolder} folder - folder to test
 ...
 * @param {import("cozy-client/types/types").IOCozyFolder} options.folder - folder to test
 * @param {import("cozy-client/types/types").IOCozyKonnector} options.konnector - konnector to which we want the reference
 ...
 * @param {object} options - options object
 * @param {CozyClient} options.client - CozyClient instance
 * @param {import("cozy-client/types/types").IOCozyFolder} options.mainFolder - Main konnector folder where the account folder may be created
 * @param {import("cozy-client/types/types").IOCozyKonnector} options.konnector - Konnector associated to the main folder
 * @param {string} options.sourceAccountIdentifier - source account identifier
 * @returns {Promise<import("cozy-client/types/types").IOCozyFolder>}
 */
